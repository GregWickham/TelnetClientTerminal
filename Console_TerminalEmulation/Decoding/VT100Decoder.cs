...
namespace ConsoleTerminalEmulation
{
    ...
    public delegate string GetDeviceCode_EventHandler();
    public delegate DeviceStatus GetDeviceStatus_EventHandler();
    public delegate void ResizeWindow_EventHandler(Size newSize);
    public delegate void MoveWindow_EventHandler(Point newPosition);

    public class VT100Decoder : AnsiDecoder
    {
        ...
        internal VT100Decoder(NetworkInterface network) => RegisterForInputFrom(network);
